...
const config = {
  ...
  resend: {
    // REQUIRED — Email 'From' field to be used when sending magic login links (must be verified in Resend)
    fromNoReply: `Ermajean <noreply@ermajean.com>`,
    // REQUIRED — Email 'From' field to be used when sending other emails, like transactional emails etc..
    fromAdmin: `Ermajean <hello@ermajean.com>`,
    // Email shown to customer if need support. Leave empty if not needed => if empty, set up Crisp above, otherwise you won't be able to offer customer support."
    supportEmail: 'hello@ermajean.com',
  },
  colors: {
